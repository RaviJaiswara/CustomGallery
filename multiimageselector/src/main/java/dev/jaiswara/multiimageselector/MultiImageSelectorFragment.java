package dev.jaiswara.multiimageselector;
...
import dev.jaiswara.multiimageselector.adapters.FolderAdapter;
import dev.jaiswara.multiimageselector.adapters.ImageGridAdapter;
import dev.jaiswara.multiimageselector.listeners.FolderOnItemClickListener;
import dev.jaiswara.multiimageselector.listeners.ImageOnItemClickListener;
import dev.jaiswara.multiimageselector.models.Folder;
import dev.jaiswara.multiimageselector.models.Image;
import dev.jaiswara.multiimageselector.utils.FileUtils;
import dev.jaiswara.multiimageselector.utils.ScreenUtils;
                ...
                if (mTmpFile != null) {
                    if (mCallback != null) {
                        ...
                        if (selectMode() == MODE_MULTI) {
                            Log.d("imageCamera", mTmpFile.getAbsolutePath());
